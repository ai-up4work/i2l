// components/platforms/MyntraProductView.tsx
'use client'
 ...
 * brand/name -> rating -> price/savings -> color swatches -> size row
 * (+ size chart) -> stock -> original listing link ->
 * MyntraCommerceActions, then a bottom-most full-width ProductInfoTabs
 * section — but restyled with Myntra's own visual language (pink
 * #ff3f6c accents, teal rating pill, "MORE COLORS" swatch strip,
 * pill-shaped size selector, openable size chart).
 *
    ...
    <div className="mx-auto max-w-6xl px-6 lg:px-10 font-sans">
      <div className="grid gap-8 sm:grid-cols-2">
        ...
        <div className="min-w-0">
          <div className="aspect-square overflow-hidden rounded-xl border border-[#eaeaec] bg-white">
            {mainImage ? (
              // eslint-disable-next-line @next/next/no-img-element
