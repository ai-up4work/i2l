 ...
 * SAME structural layout as AmazonProductView — gallery (shared
 ...
 * original listing link -> ShopifyCommerceActions, then a bottom-most
 * full-width ProductInfoTabs section — but using the app's own design
 * tokens (teal/ink/indigo-deep/gold-deep) rather than imitating a fake
