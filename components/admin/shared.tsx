...
/**
 * Compact extractor picker: a row of icon chips instead of five stacked,
        ...
        {EXTRACTOR_OPTIONS.map((opt) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-[11px] font-semibold leading-tight">{EXTRACTOR_TYPE_LABEL[opt.value]}</span>
            </button>
          )
        })}
      </div>
