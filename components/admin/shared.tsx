...
export type DetailSelectorsState = NonNullable<HtmlScrapeProviderConfig['detail']>
...
// Only used when a listing card's own detail page turns out to list
// several purchasable items itself (a wholesale "catalog" page, e.g.
// Anishka Creation) rather than being a single product's own PDP \u2014
// see HtmlScrapeProviderConfig.detail's doc comment in lib/store-config.ts.
export const DEFAULT_DETAIL_SELECTORS: DetailSelectorsState = {
  item: '',
  itemLabel: '',
  price: '',
  image: '',
