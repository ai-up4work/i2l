import { CreditCard, Headset, Link2, Package, Shield, ShoppingBag, Star, Truck } from 'lucide-react'
...
export const topChoices: TopChoiceItem[] = [
  {
    ...
    image: "/images/service-forwarding.png"
  },
  {
    icon: ShoppingBag,
  ...
  },
  {
    icon: Truck,
    title: 'Fast delivery',
    text: 'Your parcels are sent out within 1-2 working days and you’ll receive live tracking details.',
    bullets: [
      'Door-to-door delivery in 5-10 working days',
      'Track every parcel in real time',
      'SMS & email notifications for every update',
    ],
    image: "/images/service-forwarding.png"
  }
]
...
export type TrustFeature = { icon: LucideIcon; title: string; text: string }

export const trustFeatures: TrustFeature[] = [
  {
    icon: Shield,
    title: 'Secure & Transparent',
    text: 'Real-time tracking and clear pricing. No hidden fees.',
  },
  {
    icon: CreditCard,
    title: 'Multiple Payment Options',
    text: 'Pay your way with cards, bank transfer & more.',
  },
  {
    icon: Headset,
    title: 'Customer First Support',
    text: 'Our team is here to help you at every step.',
  },
  {
    icon: Star,
    title: 'Trusted by Thousands',
    text: 'Join millions of happy shoppers worldwide.',
  },
]
