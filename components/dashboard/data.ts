...
export const productImage =
  'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-IwqbRFfEGB64ThFuBivfI6ut6y0wxI.png'
...
export const offers: Offer[] = [
  ...
  {
    title: 'Cross Borders, Not Budgets',
    img: '/offers/offer2.jpg',
    tone: 'sun',
  },
  {
    title: 'Welcome to India2Lanka',
    img: '/offers/offer3.jpg',
    tone: 'welcome',
  },
  {
    title: 'Rakuten Japan Exclusive',
  ...
  {
    title: 'Anime Collectibles: 25% Off Shipping',
...
export const communityPosts: CommunityPost[] = [
  { user: 'anjali_k', tag: 'Unboxing', content: 'My eBay find finally arrived — packed so well, not a single scratch on the box!', likes: 24, comments: 6 },
  { user: 'oshan_kt', tag: 'Tip', content: 'Consolidating 4 parcels from the US saved me almost LKR 6,000 in shipping. Worth the extra wait.', likes: 41, comments: 11 },
  { user: 'binara.w', tag: 'Question', content: 'Has anyone used the proxy service for Rakuten before? Wondering about typical turnaround time.', likes: 9, comments: 14 },
  { user: 'ishara.dev', tag: 'Review', content: 'Bidding request came through under my max bid and support kept me updated the whole time.', likes: 32, comments: 4 },
  { user: 'thilini_j', tag: 'Unboxing', content: 'Sneaker restock from Japan, next-day dispatch from the warehouse. Very happy with this round.', likes: 58, comments: 9 },
]
...
export const earnMethods: EarnMethod[] = [
  {
    ...
    description: 'They get LKR 1,200 off their first order, you get credits once it ships.',
    reward: '+500 credits',
  },
  {
    title: 'Leave a review',
    description: 'Share a quick review after any delivered shipment or purchased request.',
    reward: '+50 credits',
  },
  {
    title: 'Complete your profile',
    description: 'Verify your phone number and add a delivery address.',
    reward: '+100 credits',
  },
]
...
export const referralLink = `https://india2lanka.example/r/${referralCode}`
