...
export default function ServiceCard({ image, title, description, button, onClick }: ServiceCardProps) {
  return (
    <div className="flex flex-col gap-6 rounded-2xl border border-ink/10 bg-card p-6 sm:flex-row sm:items-center sm:gap-7">
      ...
      <div className="flex flex-col items-start gap-3 sm:min-w-[200px] sm:items-center">
        <button
          onClick={onClick}
          className="flex w-full items-center justify-center gap-2 rounded-xl bg-teal px-5 py-3 text-sm font-semibold text-parchment transition-colors hover:bg-teal-deep sm:w-auto"
        >
