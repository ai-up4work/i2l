...
function QuoteDemoPage() {
  ...
  return (
    <main className="h-full overflow-y-auto bg-parchment">
      <div className="mx-auto max-w-8xl px-6 pb-20 pt-10 lg:px-10">
        ...
        <div className="grid items-stretch gap-8 lg:grid-cols-[380px_1fr]">
          {/* Inputs */}
          <div className="space-y-5 rounded-2xl border border-[#1B2A4A]/10 bg-white/80 p-6">
...
function BreakdownDialShell({
  ...
  return (
    <div className="flex h-full flex-col rounded-2xl border border-[#1B2A4A]/10 bg-white/80 p-6">
...
function ResultRow({
  ...
  return (
    <div className="group relative rounded-xl border border-[#1B2A4A]/10 bg-white/80 px-4 py-3">
