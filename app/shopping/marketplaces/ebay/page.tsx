...
export const metadata = {
  title: 'eBay | Buyandship',
  description: 'Official eBay partner — one-stop proxy ordering and forwarding.',
}
  ...
  return (
    <main className="mx-auto flex min-h-[70vh] max-w-3xl flex-col items-start justify-center px-6 py-24">
      ...
      <p className="mt-4 max-w-xl text-base leading-relaxed text-muted">
        Official eBay partner — one-stop proxy ordering and forwarding.
      </p>

      <p className="mt-2 font-mono text-xs text-ink/40">
        /shopping/marketplaces/ebay
      </p>
