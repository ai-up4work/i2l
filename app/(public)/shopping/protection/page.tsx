...
export const metadata = {
  title: 'Shopping protection plan | Buyandship',
  description: '7-day safe returns for secure online shopping.',
}
  ...
  return (
    <main className="mx-auto flex min-h-[70vh] max-w-3xl flex-col items-start justify-center px-6 py-24">
      ...
      <h1 className="font-display text-4xl font-semibold tracking-tight text-ink sm:text-5xl">
        Shopping protection plan
      </h1>

      <p className="mt-4 max-w-xl text-base leading-relaxed text-muted">
        7-day safe returns for secure online shopping.
      </p>
