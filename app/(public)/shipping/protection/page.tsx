...
export const metadata = {
  title: 'Shipping protection plan | Buyandship',
  description: 'Secure your international shipments against loss or damage.',
}
  ...
  return (
    <main className="mx-auto flex min-h-[70vh] max-w-3xl flex-col items-start justify-center px-6 py-24">
      ...
      <p className="mt-4 max-w-xl text-base leading-relaxed text-muted">
        Secure your international shipments against loss or damage.
      </p>
