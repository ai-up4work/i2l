...
export const metadata = {
  title: 'Forwarding services | Buyandship',
  description: 'Ship packages from 10+ countries straight to your door.',
}
  ...
  return (
    <main className="mx-auto flex min-h-[70vh] max-w-3xl flex-col items-start justify-center px-6 py-24">
      ...
      <p className="mt-4 max-w-xl text-base leading-relaxed text-muted">
        Ship packages from 10+ countries straight to your door.
      </p>
