...
export const metadata = {
  title: 'Trending products | Buyandship',
  description: 'Based on what other users are buying right now.',
}
  ...
  return (
    <main className="mx-auto flex min-h-[70vh] max-w-3xl flex-col items-start justify-center px-6 py-24">
      ...
      <p className="mt-4 max-w-xl text-base leading-relaxed text-muted">
        Based on what other users are buying right now.
      </p>

      <p className="mt-2 font-mono text-xs text-ink/40">
        /community/discover/recommended
      </p>
