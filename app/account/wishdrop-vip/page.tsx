...
export default function VipPage({
  ...
  // currentTier can arrive undefined while user/loyalty data is still
  // loading, or if the caller hasn't wired this prop yet — default to the
  // base tier rather than letting every .charAt/.indexOf call below throw.
    ...
    <div className="mx-auto max-w-5xl px-6 pb-8 lg:px-10">
      ...
      <div className="mt-4 grid gap-6 rounded-2xl border border-ink/10 bg-card p-6 lg:grid-cols-[1fr_1.4fr]">
        <div className="flex flex-col gap-4">
          ...
          <TierProgress currentTier={safeTier} progressToNext={progressToNext} />
