...
export default function BoardDetailPage() {
  ...
  // "Add All to Cart" — push every item in the board through the cart in one
  // go. The cart itself is the source of truth on availability; we just
  // report back how many made it in vs. were skipped.
...
// ---------------------------------------------------------------------------
// Item card — image, title, price, variant, a quantity stepper, remove and
// per-item add-to-bag.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Share modal — generates/revokes the board's share link.
// ---------------------------------------------------------------------------
