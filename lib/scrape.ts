...
export async function scrapeProduct(url: string): Promise<ScrapedProduct> {
  ...
  return {
    name: fromJsonLd.name ?? fromMeta.name ?? null,
    image: fromJsonLd.image ?? fromMeta.image ?? null,
    price: fromJsonLd.price ?? fromMeta.price ?? null,
    currency: fromJsonLd.currency ?? fromMeta.currency ?? null,
    siteName: fromMeta.siteName ?? null,
  }
}
